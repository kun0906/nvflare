...
1. HPC Instructions:
    ...
    $PYTHONPATH=.:nsf python3 nsf/fl_cnn_robust_aggregation_random_noise_model_shakespeare.py
...
def gen_client_data(data_dir='data/Sentiment140', out_dir='.', CFG=None):
    ...
    # df = pd.read_csv('data/SHAKESPEARE/shakespeare_plays.csv_bert.csv',
    #                  dtype=float, header=None, skiprows=skip.tolist())
    # csv_file = 'data/SHAKESPEARE/shakespeare_plays.csv_bert.csv'
    csv_file = 'data/SHAKESPEARE/shakespeare_plays.csv_bert.csv_reduced.csv'
...
def main():
    ...
    for train_val_seed in range(0, 1000, 1000 // NUM_REPEATS):
        ...
        data_dir = (f'data/SHAKESPEARE/random_noise_model/h_{CFG.NUM_HONEST_CLIENTS}-b_{CFG.NUM_BYZANTINE_CLIENTS}'
    ...
    # history_file = 'data/Sentiment140/sign_flipping/h_12-b_8-5-0.8-0.1-krum_avg/all_histories_3.pth'
