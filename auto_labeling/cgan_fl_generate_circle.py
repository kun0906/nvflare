...
def client_i_training(X_train, y_train, l, global_gan):
    # print(f'\nclient_{client_i}')
    # l = client_i
    ...
    global_gan.load_state_dict(generator.state_dict())
...
def train_gan(X_train, y_train, X_val, y_val, X_test, y_test):
    ...
    for server_epoch in range(SERVER_EPOCHS):
        ...
        for l in LABELs:  # we have 10 clients, recircle train global_gan
            client_i_training(X_train, y_train, l, global_gan)
