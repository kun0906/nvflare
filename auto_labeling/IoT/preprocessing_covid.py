"""
   ...
   https://www.kaggle.com/datasets/datatattle/covid-19-nlp-text-classification?select=Corona_NLP_train.csv
    ...
    $PYTHONPATH=.:nsf python3 nsf/preprocessing_covid.py
...
@timer
def preprocessing():
    in_file = 'data/COVID/Corona_NLP_train.csv'
    ...
    df.dataframeName = 'Combined Data.csv'
    ...
    labels, texts = df['Sentiment'].tolist(), df['OriginalTweet'].tolist()
    print(collections.Counter(labels))

    classes = ['Positive', 'Negative', 'Neutral', 'Extremely Positive', 'Extremely Negative']
