...
def parse_arguments():
    ...
    parser.add_argument('-r', '--labeling_rate', type=float, required=False, default=512,
...
def main():
    ...
    for train_val_seed in range(0, 1000, 1000 // NUM_REPEATS):
        ...
        data_dir = (f'data/Sentiment140/random_noise_model/h_{CFG.NUM_HONEST_CLIENTS}-b_{CFG.NUM_BYZANTINE_CLIENTS}'
