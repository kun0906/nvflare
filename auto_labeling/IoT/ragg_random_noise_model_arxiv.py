...
1. HPC Instructions:
    ...
    $PYTHONPATH=.:nsf python3 nsf/fl_cnn_robust_aggregation_random_noise_model_arxiv.py
...
def main():
    ...
    for train_val_seed in range(0, 1000, 1000 // NUM_REPEATS):
        ...
        data_dir = (f'data/arXiv/random_noise_model/h_{CFG.NUM_HONEST_CLIENTS}-b_{CFG.NUM_BYZANTINE_CLIENTS}'
