...
def parse():
    ...
    parser.add_argument("--client_idx", type=int, default=2, help="The index of the client")    # client index starts from 1, not 0
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        while True:
            try:
                ...
                print(f"[Client {CLIENT_IDX}] Sending updated value: {updated_local_data.keys()}")
