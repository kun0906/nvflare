...
1. HPC Instructions:
    ...
    $PYTHONPATH=.:nsf python3 nsf/fl_cnn_robust_aggregation_random_noise_model_fakenews.py
...
@timer
def gen_client_data(data_dir='data/FakeNews', out_dir='.', CFG=None):
    ...
    df = pd.read_csv('data/FakeNews/Fake.csv_bert.csv',
...
def main():
    ...
    for train_val_seed in range(0, 1000, 1000 // NUM_REPEATS):
        ...
        data_dir = (f'data/FakeNews/random_noise_model/h_{CFG.NUM_HONEST_CLIENTS}-b_{CFG.NUM_BYZANTINE_CLIENTS}'
    ...
    # history_file = 'data/FakeNews/sign_flipping/h_12-b_8-5-0.8-0.1-krum_avg/all_histories_3.pth'
