...
def plot_robust_aggregation_all(end=24):
    """
       single point: 'adaptive_krum' 'krum' 'adaptive_krum+rp' 'krum+rp' 'median' 'mean'
...
if __name__ == '__main__':
    ...
    ##############################################################################
    # Non IID case, alpha = 0.5, 1.0, 5.0, 10, n_clients:100, epochs:100
    JOBID = 291224  # omniscient
    JOBID = 291279  # gaussian
    ...
    plot_robust_aggregation_all(end=100)
    print('finished')
