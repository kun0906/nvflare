...
1. HPC Instructions:
    ...
    $PYTHONPATH=.:nsf python3 nsf/fl_cnn_robust_aggregation_large_values_model_arxiv.py
...
@timer
def gen_client_data(data_dir='data/arXiv', out_dir='.', CFG=None):
    ...
    df = pd.read_csv('data/arXiv/arXiv_scientific dataset.csv_bert.csv',
...
def main():
    ...
    for train_val_seed in range(0, 1000, 1000 // NUM_REPEATS):
        ...
        data_dir = (f'data/arXiv/large_values_model/h_{CFG.NUM_HONEST_CLIENTS}-b_{CFG.NUM_BYZANTINE_CLIENTS}'
    ...
    # history_file = 'data/arXiv/sign_flipping/h_12-b_8-5-0.8-0.1-krum_avg/all_histories_3.pth'
