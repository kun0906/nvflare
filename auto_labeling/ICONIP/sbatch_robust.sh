...
# each task needs 5GB, 30 tasks cost 30*5 = 150GB
...
# sentiment140
#PYTHONPATH=.:nsf python3 nsf/fl_cnn_robust_aggregation_large_values_model_sentiment140.py $PARAMS
#PYTHONPATH=.:nsf python3 nsf/fl_cnn_robust_aggregation_random_noise_model_sentiment140.py $PARAMS
#PYTHONPATH=.:nsf python3 nsf/fl_cnn_robust_aggregation_label_flipping_sentiment140.py $PARAMS
