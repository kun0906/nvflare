...
def parse_arguments():
    parser = argparse.ArgumentParser()
    parser.add_argument("--workspace", "-m", type=str, help="WORKSPACE folder", default='.', required=False)
    parser.add_argument("--fed_client", "-s", type=str, help="client config json file", default='fed_client.json', required=False)
