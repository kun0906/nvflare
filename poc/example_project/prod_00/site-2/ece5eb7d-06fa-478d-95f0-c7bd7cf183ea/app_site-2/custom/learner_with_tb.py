...
class PTLearner(Learner):
    def __init__(
            self,
            train_path='~/data/reverse_label/client_2_airplane_train.pkl',
            test_path='~/data/reverse_label/client_2_airplane_test.pkl',
            site_id=2,
            lr=0.01,
            epochs=5,
            exclude_vars=None,
    ...
    def get_weights(self):
        ...
        outgoing_dxo = DXO(
            data_kind=DataKind.WEIGHTS, data=weights, meta={MetaKey.NUM_STEPS_CURRENT_ROUND: self.epoches}
        )
    ...
    def train(self, data: Shareable, fl_ctx: FLContext, abort_signal: Signal) -> Shareable:
        ...
        outgoing_dxo = DXO(
            data_kind=DataKind.WEIGHTS, data=new_weights, meta={MetaKey.NUM_STEPS_CURRENT_ROUND: self.epoches}
        )
        return outgoing_dxo.to_shareable()
