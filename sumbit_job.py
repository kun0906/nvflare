# from nvflare.apis.client import FLAdminAPI
...
# app_dir = "/Users/49751124/PycharmProjects/nvflare/NVFlare/examples/hello-world/hello-pt/jobs/hello-pt"  # Replace with the path to your app directory
...
def main():
    ...
    parser.add_argument("--workspace", "-m", type=str, default='/tmp/nvflare/poc/example_project/prod_00/admin@nvidia.com', help="WORKSPACE folder", required=False)

    parser.add_argument(
        "--fed_admin", "-s", type=str, default="/tmp/nvflare/poc/example_project/prod_00/admin@nvidia.com/startup/fed_admin.json", help="json file with configurations for launching admin client", required=False
    )
