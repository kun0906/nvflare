...
from nvflare.app_common.state_persistors.storage_state_persistor import StorageStatePersistor
...
class SimulatorDeployer(ServerDeployer):
    def __init__(self):
        ...
        storage = FilesystemStorage(root_dir=os.path.abspath('file_system_storage'), uri_root='uri')
        self.snapshot_persistor = StorageStatePersistor(storage, uri_root='storage_state')
    ...
    def create_fl_client(self, client_name, args):
        ...
        client_engine = SimulatorParentClientEngine(federated_client, args)
