...
def main():
    ...
    parser.add_argument("--admin_dir", type=str, default="/tmp/nvflare/poc/example_project/prod_00/admin@nvidia.com", help="Path to admin directory.")
    parser.add_argument("--username", type=str, default="admin@nvidia.com", help="Admin username.")
    parser.add_argument("--job", type=str, default="/Users/49751124/PycharmProjects/nvflare/NVFlare/examples/hello-world/hello-pt/jobs/hello-pt", help="Path to job")
    ...
    job_name ='app' # os.path.basename(args.job)
